...
class Skills extends Component {
  ...
  handleScroll(event) {
    ...
    const minlimit = (documentElement.clientHeight * 550) / documentElement.scrollHeight;
    const maxlimit = (documentElement.clientHeight * 900) / documentElement.scrollHeight;
