...
class Contact extends Component {
  ...
  handleScroll(event) {
    ...
    const minlimit = (documentElement.clientHeight * 700) / documentElement.scrollHeight;
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
          ...
          <SocialLogo imgURL={githubImg} alternate="github" redirectURL="https://github.com/AcevedoEsteban" />
          <SocialLogo imgURL={mailImg} alternate="mail" redirectURL="mailto:aa.Esteban.Acevedo@gmail.com" />
          {/* <SocialLogo imgURL={instaImg} alternate="insta" redirectURL="https://www.instagram.com/" /> */}
          <SocialLogo imgURL={linkedInImg} alternate="linkedin" redirectURL="https://www.linkedin.com/in/esteban-acevedo/" />
        </SocialMediaIcons>
      </Container>
    );
  }
